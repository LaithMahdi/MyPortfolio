  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center  h-full text-white">
        ...
        <div>
          <p className="text-4xl font-bold inline border-b-4 border-[#00FFCA]">Skills</p>
          <p className="py-6">I have used and worked with the following technologies in my projects.</p>
        </div>
